...
```{r}
#Load Model
load("2021_cnblup.Rdata")
load("2021_indices_fixed.Rdata")
load("2021_multi2_fixed.Rdata")
load("2021_multi3_fixed.Rdata")
```
...
#All
# "Harrington" "Lind" "Ritzville"  "Pullman"   "Davenport"  "WallaWalla" "Kahlotus"
#SP - Prelim - AWY1 -AWY2
trial <- "All"
...
##Multivariate Models ------------------------------------------------------------------------------------------------------
```{r}
load("2021_indices.Rdata")
load("2021_multi2.Rdata")
load("2021_multi3.Rdata")
```
