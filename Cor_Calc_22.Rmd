...
```{r}
#Load Model
load("2022_cnblup.Rdata")
load("2022_indices_fixed.Rdata")
load("2022_multi2_fixed.Rdata")
load("2022_multi3_fixed.Rdata")
```
...
#All
# "Pullman" "Farmington" "Harrington" "Davenport" "Ritzville" "Prescott" 
#SP - Prelim - AWY1 -AWY2
trial <- "AWY2" 
...
#tester<-tester[tester$ENV == trial,] #Location
tester<-tester[tester$Trial == trial,] #Trial Type
...
##Multivariate Models ------------------------------------------------------------------------------------------------------
```{r}
load("2022_indices.Rdata")
load("2022_multi2.Rdata")
load("2022_multi3.Rdata")
```
