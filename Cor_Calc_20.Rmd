...
```{r}
#Load Model
load("2020_cnblup.Rdata")
load("2020_indices_fixed.Rdata")
load("2020_multi2_fixed.Rdata")
load("2020_multi3_fixed.Rdata")
```
...
##Multivariate Models ------------------------------------------------------------------------------------------------------
```{r}
load("2020_indices.Rdata")
load("2020_multi2.Rdata")
load("2020_multi3.Rdata")
```
